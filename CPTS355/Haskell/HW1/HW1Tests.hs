...
p1a_test4 = TestCase (assertEqual "getUniqueRight-test4" [1]  (getUniqueRight [1, 1, 1, 1, 1, 1, 1]) ) 
...
p1b_test4 = TestCase (assertEqual "getUniqueLeft-test4" [-1, -2, -7, 4, 3] (getUniqueLeft [-1, -2, -7, 4, -7, 3, 3, -2]) ) 
...
p2c_test3 = TestCase (assertEqual "(getMonths-test3)" [] (getMonths myCatsLog 1 "Ice Cream") ) 
...
p3_test5 = TestCase (assertEqual "deepCount-test5" 0  (deepCount 1 [[], [], [], []]) )
p3_test6 = TestCase (assertEqual "deepCount-test6" 4  (deepCount [] [[[], []], [[], [1,2]], [[]]]) ) 
...
p4_test6 = TestCase (assertEqual "clusterConsequtive-test6" [[5], [4], [3], [2], [1]] (clusterConsecutive [5, 4, 3, 2, 1]) ) 
p4_test7 = TestCase (assertEqual "clusterConsequtive-test7" [[-1, 0, 1], [3], [5]]  (clusterConsecutive [-1, 0, 1, 3, 5]) )
